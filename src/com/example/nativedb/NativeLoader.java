...
public class NativeLoader {
	...
	private final static String LIB_NAME = "nativeDB";// + LIB_VERSION;
		...
		try {
			...
			try {
				if (Build.CPU_ABI.equalsIgnoreCase("armeabi-v7a")) {
					...
					folder = "armeabi";
					Log.e("nativeDB", "Unsupported arch: " + Build.CPU_ABI);
				}
			} catch (Exception e) {
				Log.e("nativeDB", e.getMessage());
				folder = "armeabi";
			...
			if (destFile != null) {
				...
				if (destFile.exists()) {
					Log.e("nativeDB", "Load normal lib");
					try {
			...
			Log.e("nativeDB", "Library not found, arch = " + folder);
